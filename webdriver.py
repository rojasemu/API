...
def intercept(request):
    if 'https://dkr1.ssisurveys.com' in request.url:
        request.abort()

def interceptcint(request):
    if 'https://s.cint.com' in request.url:
        request.abort()

def iniciar_chrome_bots():
    ...
    #options.add_extension('C:/Users/Rojasemu/AppData/Local/Google/Chrome/User Data/Default/Extensions/bfgblailifedppfilabonohepkofbkpm/1.3.0_0/webRequest.crx')
