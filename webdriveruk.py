...
#from selenium import webdriver as webdriveruk

from selenium.webdriver.chrome.service import Service
from seleniumwire  import webdriver as webdriveruk
...
def iniciar_chrome_uk():
    ...
    options_seleniumWire = {
        'proxy': {
            'https': 'https://Seljesusvirus2007:JesusMata2323@85.209.177.90:50100',
        }
    }
    ...
    driveruk= webdriveruk.Chrome(service=s, options=options, seleniumwire_options=options_seleniumWire, desired_capabilities=capa) # añadimos el argumento OPTIONS  desired_capabilities=capa
